 ...
 */
#ifndef __OMV2640_REGS_H__
#define __OMV2640_REGS_H__
...
#define CTRLI_V_DIV_SET(x)      VAL_SET(x, 0x7, 0, 3)
#define CTRLI_H_DIV_SET(x)      VAL_SET(x, 0x7, 0, 0)
