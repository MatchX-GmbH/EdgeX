...
LoRaMacStatus_t LoRaMacInitialization( LoRaMacPrimitives_t* primitives, LoRaMacCallback_t* callbacks, LoRaMacRegion_t region )
{
    ...
    MacCtx.TxDelayedTimer.name = "TxDelayedTimer";
    MacCtx.RxWindowTimer1.name = "RxWindowTimer1";
    MacCtx.RxWindowTimer2.name = "RxWindowTimer2";
    MacCtx.AckTimeoutTimer.name = "AckTimeoutTimer";
