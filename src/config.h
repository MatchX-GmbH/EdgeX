...
#define ADC_IO_I2C_SDA_PIN	34
#define ADC_IO_I2C_SDA_FUNC	(FUNC_I2C1_SDA)
#define ADC_IO_I2C_SCL_PIN	35
#define ADC_IO_I2C_SCL_FUNC	(FUNC_I2C1_SCLK)
#define ADC_I2C_DEV	        	I2C_DEVICE_1
